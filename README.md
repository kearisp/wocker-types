...
[![npm version](https://img.shields.io/npm/v/@wocker/types.svg)](https://www.npmjs.com/package/@wocker/types)
[![Publish](https://github.com/kearisp/wocker-types/actions/workflows/publish-latest.yml/badge.svg?event=release)](https://github.com/kearisp/wocker-types/actions/workflows/publish-latest.yml)
[![License](https://img.shields.io/npm/l/@wocker/types)](https://github.com/kearisp/wocker-types/blob/master/LICENSE)

[![npm total downloads](https://img.shields.io/npm/dt/@wocker/types.svg)](https://www.npmjs.com/package/@wocker/types)
[![bundle size](https://img.shields.io/bundlephobia/minzip/@wocker/types)](https://bundlephobia.com/package/@wocker/types)
